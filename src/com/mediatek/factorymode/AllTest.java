...
/*   on: Mon, 06 Apr 2015 23:35:48 +0800
...
// End of
        ...
        if (requestCode == AppDefine.FT_FUELGAUGE) {
            intent.setClassName(this, "com.mediatek.factorymode.gps.GPSTest");
            requestid = AppDefine.FT_GPSTEST;
        }
        if (requestCode == AppDefine.FT_GPSTEST) {
            OnFinish();
            return;
        }
