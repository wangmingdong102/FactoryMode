...
public class CameraTest extends Activity implements OnClickListener {
    ...
    SurfaceHolder.Callback surfaceCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            ...
            mFocusAreaSupported = (parameters.getMaxNumFocusAreas() > 0
                    && isSupported(Parameters.FOCUS_MODE_AUTO, supportedFocusModes));
            if (mFocusAreaSupported) {
        ...
        public void surfaceDestroyed(SurfaceHolder holder) {
            if (mCamera != null) {
                if (mIsPreview) {
                    mCamera.stopPreview();
/*     on: Sat, 01 Nov 2014 14:25:01 +0800
 * implement#105079,avoid crash
 */
                    mCamera.release();
                    mCamera = null;
// End of
