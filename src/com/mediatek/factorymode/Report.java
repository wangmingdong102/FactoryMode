...
public class Report extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < FactoryMode.itemString.size(); i++) {
            ...
            String itemKey = Integer.toString(FactoryMode.itemString.get(i));
            if ((AppDefine.FT_SUCCESS).equals(mSp.getString(itemKey, null))) {
                mOkList.add(item);
            } else if ((AppDefine.FT_FAILED).equals(mSp.getString(itemKey, null))) {
