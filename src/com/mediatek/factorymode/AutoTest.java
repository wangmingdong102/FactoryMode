...
/*    on: Wed, 10 Jul 2013 15:20:32 +0800
 * Added for generate IMEI automatically
 */
        this.sendBroadcast(new Intent("com.mediatek.factorymode.gen.imei.auto"));
// End of
    }
...
/*   on: Mon, 06 Apr 2015 23:32:59 +0800
 * implement #124374, add flash test
 */
            intent.setClassName(this, "com.mediatek.factorymode.flash.Flash");
            requestid = AppDefine.FT_FLASH;
        }
        if (requestCode == AppDefine.FT_FLASH) {
// End of
        ...
        if (requestCode == AppDefine.FT_SIGNALID) {
            intent.setClassName(this, "com.mediatek.factorymode.battery.BatteryCheck");
            requestid = AppDefine.FT_BATTERYCHECK;
        }
        if (requestCode == AppDefine.FT_BATTERYCHECK) {
        ...
        if (requestCode == AppDefine.FT_FMRADIOID) {
            intent.setClassName(this, "com.mediatek.factorymode.sdcard.SDCardFormat");
            requestid = AppDefine.FT_SDCARDFORMATID;
        }
        if (requestCode == AppDefine.FT_SDCARDFORMATID) {
